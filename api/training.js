...
router.put('/:id', (req, res) => {
    getConnection(con => {
        const allowed_keys = ["order_code", "company_code", "company_name", "training_name", "summary", "tips", "start_time", "end_time", "manual", "manned_title", "unmanned_title", "special_title"]
